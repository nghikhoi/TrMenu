 ...
 */
class ActionOptEcoSet(content: String, option: ActionOption) : AbstractAction(content, option) {
    ...
    companion object {
        ...
        private val name = "(set|modify)-?opteco?".toRegex()

        private val parser: (Any, ActionOption) -> AbstractAction = { value, option ->
            ActionOptEcoSet(value.toString(), option)
        }
