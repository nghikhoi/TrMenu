 ...
 */
class ActionOptEcoAdd(content: String, option: ActionOption) : AbstractAction(content, option) {
    ...
    companion object {
        ...
        private val name = "(give|add|deposit)-?opteco?".toRegex()

        private val parser: (Any, ActionOption) -> AbstractAction = { value, option ->
            ActionOptEcoAdd(value.toString(), option)
        }
